...
<div className='text-center my-8 '>
    ...
    <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>  Explore the latest insights, tips, and trends across a variety of topics. Dive into fresh content curated just for you!
